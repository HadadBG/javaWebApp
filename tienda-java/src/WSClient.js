  ...
  json = (function recurse (obj, prop, parent) {
    ...
    if (Object.prototype.toString.call(obj) === '[object Array]') {
      ...
      // check also if the array element is not a primitive value
      {
        ...
        { continue } else if ('$ref' in obj[i]) { obj[i] = recurse(obj[i], i, obj) } else { obj[i] = recurse(obj[i], prop, obj) }
      }
      return obj
    }
    if ('$ref' in obj) {
      ...
      { obj = obj.$values.map(recurse) } else // a plain object
      {
        for (var prop in obj) { obj[prop] = recurse(obj[prop], prop, obj) }
      }
      byid[id] = obj
    }
    return obj
